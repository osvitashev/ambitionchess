...
class BoardTest {
	...
	@Test
	void testGetPieces() {
		assertEquals(0x852a501048a700L, new Board("r3k1r1/pbpnq2p/1p1p1p1n/4p1p1/4P3/3P1NP1/PPPBQPBP/2KR2R1 w q - 0 1").getPieces(PieceType.PAWN));
		assertEquals(0x4100000000000048L, new Board("r3k1r1/pbpnq2p/1p1p1p1n/4p1p1/4P3/3P1NP1/PPPBQPBP/2KR2R1 w q - 0 1").getPieces(PieceType.ROOK));
		assertEquals(0x8400000000000048L, new Board("2r1k2r/pbpnq2p/1p1p1p1n/4p1p1/4P3/3P1NP1/PPPBQPBP/2KR2R1 w k - 0 1").getPieces(PieceType.ROOK));// test
																																						// rook
																																						// on
																																						// cursed
																																						// h8
		assertEquals(0x1000000000000004L, new Board("r3k1r1/pbpnq2p/1p1p1p1n/4p1p1/4P3/3P1NP1/PPPBQPBP/2KR2R1 w q - 0 1").getPieces(PieceType.KING));
		assertEquals(0x8800000200000L, new Board("r3k1r1/pbpnq2p/1p1p1p1n/4p1p1/4P3/3P1NP1/PPPBQPBP/2KR2R1 w q - 0 1").getPieces(PieceType.KNIGHT));
		assertEquals(0x2000000004800L, new Board("r3k1r1/pbpnq2p/1p1p1p1n/4p1p1/4P3/3P1NP1/PPPBQPBP/2KR2R1 w q - 0 1").getPieces(PieceType.BISHOP));
		assertEquals(0x10000000001000L, new Board("r3k1r1/pbpnq2p/1p1p1p1n/4p1p1/4P3/3P1NP1/PPPBQPBP/2KR2R1 w q - 0 1").getPieces(PieceType.QUEEN));
	}

	@Test
	void testGetPlayerPieces() {
		assertEquals(0x949faa5000000000L, new Board("2r1k2r/pbpnq2p/1p1p1p1n/4p1p1/4P3/3P1NP1/PPPBQPBP/2KR2R1 w k - 0 1").getPlayerPieces(Player.BLACK));
		assertEquals(0x1068ff4cL, new Board("r3k1r1/pbpnq2p/1p1p1p1n/4p1p1/4P3/3P1NP1/PPPBQPBP/2KR2R1 w q - 0 1").getPlayerPieces(Player.WHITE));
	}
	...
	@Test
	void testBitAccess() {
		Board brd = new Board("2r1k2r/pbpnq2p/3p3n/1p2p1p1/4P3/1P1PQNP1/P1P3BP/1R1K2R1 w KQkq - 0 1");
		...
		try {
			Method method = Board.class.getDeclaredMethod("putPieceAt", int.class, int.class, int.class);
			method.setAccessible(true);
	...
	@Test
	void testToString() {
		Board brd = new Board("8/4b3/4P3/1k4P1/8/ppK5/8/4R3 b - - 1 45");
	...
	@Test
	void testClear() {
		Board brd = new Board("2r1k2r/pbpnq2p/1p1p1p1n/4p1p1/4P3/3P1NP1/PPPBQPBP/1R1K2R1 w KQkq e3 5 3");
		try {
			Method method = Board.class.getDeclaredMethod("clear");
			method.setAccessible(true);
		...
		brd = new Board("8/1kr5/8/8/8/2K5/8/8 w - - 0 1");
	...
	void testLoadFromFEN() {
		Board brd = new Board("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1");
		assertEquals(0, brd.getQuietHalfmoveClock());
		assertEquals(0, brd.getGamePlyCount());

		brd = new Board("rnbqkbnr/pppppppp/8/8/8/2N5/PPPPPPPP/R1BQKBNR b KQkq - 1 1");
		assertEquals(1, brd.getQuietHalfmoveClock());
		assertEquals(1, brd.getGamePlyCount());

		brd = new Board("rnbqkbnr/ppp1pppp/8/3p4/8/2N5/PPPPPPPP/R1BQKBNR w KQkq - 0 2");
		assertEquals(0, brd.getQuietHalfmoveClock());
		assertEquals(2, brd.getGamePlyCount());

		brd = new Board("rnbqk2r/ppp1b1pp/5p1n/3p4/8/3B1N2/PPPP1PPP/RNBQK2R w KQkq - 4 1");
	...
	void testIsSquareAttackedBy() {
		// king
		assertEquals(true, new Board("8/1k6/5n2/4K3/8/3P4/8/8 w - - 0 1").isSquareAttackedBy(Square.F6, Player.WHITE));
		assertEquals(true, new Board("8/6K1/5n2/5k2/8/3P4/8/8 w - - 0 1").isSquareAttackedBy(Square.F6, Player.WHITE));
		assertEquals(false, new Board("8/8/2K2nk1/8/8/3P4/8/8 w - - 0 1").isSquareAttackedBy(Square.F6, Player.WHITE));
		assertEquals(true, new Board("8/8/2K2nk1/8/8/3P4/8/8 w - - 0 1").isSquareAttackedBy(Square.F6, Player.BLACK));
		assertEquals(true, new Board("8/4K3/5nk1/8/8/3P4/8/8 w - - 0 1").isSquareAttackedBy(Square.F6, Player.BLACK));
		assertEquals(false, new Board("8/4K3/5n2/8/7k/3P4/8/8 w - - 0 1").isSquareAttackedBy(Square.F6, Player.BLACK));
		// pawns
		assertEquals(false, new Board("8/1k6/8/1P6/4K3/8/8/8 w - - 0 1").isSquareAttackedBy(Square.C4, Player.WHITE));
		assertEquals(false, new Board("8/1k6/8/3P4/4K3/8/8/8 w - - 0 1").isSquareAttackedBy(Square.C4, Player.WHITE));
		assertEquals(true, new Board("8/1k6/8/8/4K3/3P4/8/8 w - - 0 1").isSquareAttackedBy(Square.C4, Player.WHITE));
		assertEquals(true, new Board("8/1k6/8/8/4K3/1P6/8/8 w - - 0 1").isSquareAttackedBy(Square.C4, Player.WHITE));
		assertEquals(true, new Board("8/1k6/8/3pK3/8/8/8/8 w - - 0 1").isSquareAttackedBy(Square.C4, Player.BLACK));
		assertEquals(true, new Board("8/1k6/8/1p2K3/8/8/8/8 w - - 0 1").isSquareAttackedBy(Square.C4, Player.BLACK));
		assertEquals(false, new Board("8/1k6/8/3PK3/8/1p6/8/8 w - - 0 1").isSquareAttackedBy(Square.C4, Player.BLACK));
		assertEquals(false, new Board("8/1k6/8/1P2K3/8/3p4/8/8 w - - 0 1").isSquareAttackedBy(Square.C4, Player.BLACK));
		// rook
		assertEquals(true, new Board("8/8/1R1N3k/8/8/8/1K6/8 w - - 0 1").isSquareAttackedBy(Square.D6, Player.WHITE));
		assertEquals(true, new Board("3R4/8/3N2rk/8/8/8/1K6/8 w - - 0 1").isSquareAttackedBy(Square.D6, Player.WHITE));
		assertEquals(false, new Board("4R3/8/3N2rk/8/8/8/1K6/8 w - - 0 1").isSquareAttackedBy(Square.D6, Player.WHITE));
		assertEquals(true, new Board("8/8/3N2rk/8/8/8/1K6/3R4 w - - 0 1").isSquareAttackedBy(Square.D6, Player.BLACK));
		assertEquals(true, new Board("8/8/3N2rk/8/8/8/1K2R3/8 w - - 0 1").isSquareAttackedBy(Square.D6, Player.BLACK));
		assertEquals(false, new Board("8/6r1/2RN3k/8/8/8/1K6/8 w - - 0 1").isSquareAttackedBy(Square.D6, Player.BLACK));
		// bishop
		assertEquals(true, new Board("8/8/3N3k/8/8/6B1/1K6/8 w - - 0 1").isSquareAttackedBy(Square.D6, Player.WHITE));
		assertEquals(true, new Board("8/4b3/3N3k/8/1B6/8/1K6/8 w - - 0 1").isSquareAttackedBy(Square.D6, Player.WHITE));
		assertEquals(false, new Board("1b6/8/3N3k/8/2B5/8/1K6/8 w - - 0 1").isSquareAttackedBy(Square.D6, Player.WHITE));
		assertEquals(true, new Board("1b6/8/3N3k/8/2B5/8/1K6/8 w - - 0 1").isSquareAttackedBy(Square.D6, Player.BLACK));
		assertEquals(true, new Board("8/4B3/3N3k/8/1b6/8/1K6/8 w - - 0 1").isSquareAttackedBy(Square.D6, Player.BLACK));
		assertEquals(false, new Board("8/2B5/3N3k/1b6/8/8/1K6/8 w - - 0 1").isSquareAttackedBy(Square.D6, Player.BLACK));
		// queen
		assertEquals(true, new Board("8/7k/1Q1n4/8/8/7K/8/8 w - - 0 1").isSquareAttackedBy(Square.D6, Player.WHITE));
		assertEquals(true, new Board("8/7k/3n4/8/8/Q6K/8/8 w - - 0 1").isSquareAttackedBy(Square.D6, Player.WHITE));
		assertEquals(false, new Board("1q6/7k/3n4/8/Q7/7K/8/8 w - - 0 1").isSquareAttackedBy(Square.D6, Player.WHITE));
		assertEquals(true, new Board("1q6/7k/3n4/8/Q7/7K/8/8 w - - 0 1").isSquareAttackedBy(Square.D6, Player.BLACK));
		assertEquals(true, new Board("8/7k/3n1q2/8/Q7/7K/8/8 w - - 0 1").isSquareAttackedBy(Square.D6, Player.BLACK));
		assertEquals(false, new Board("6q1/7k/3n4/8/8/7K/8/3Q4 w - - 0 1").isSquareAttackedBy(Square.D6, Player.BLACK));
		// knight
		assertEquals(true, new Board("6k1/8/3n4/8/4N3/8/6K1/8 w - - 0 1").isSquareAttackedBy(Square.D6, Player.WHITE));
		assertEquals(true, new Board("2n3k1/8/3n4/8/4N3/8/6K1/8 w - - 0 1").isSquareAttackedBy(Square.D6, Player.WHITE));
		assertEquals(false, new Board("2n3k1/8/3n4/4N3/8/8/6K1/8 w - - 0 1").isSquareAttackedBy(Square.D6, Player.WHITE));
		assertEquals(true, new Board("6k1/8/3n4/1n2N3/8/8/6K1/8 w - - 0 1").isSquareAttackedBy(Square.D6, Player.BLACK));
		assertEquals(true, new Board("6k1/8/3n4/1n6/2N5/8/6K1/8 w - - 0 1").isSquareAttackedBy(Square.D6, Player.BLACK));
