...
class EvaluatorPestoTest {
	...
	void testWithContext() {
		...
		context.getBrd().loadFromFEN("8/4nr2/3kp3/8/B7/1PP5/2K5/8 w - - 0 1");
		assertTrue(context.getEvaluator().evaluate()<0);
		context.getBrd().loadFromFEN("8/4nr2/3kp3/8/B7/1PP5/2K5/8 b - - 0 1");
		assertTrue(context.getEvaluator().evaluate()>0);
