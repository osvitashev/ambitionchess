...
class BSEETest_evaluatePerftChecksum {
	...
	private void updateHashValue() {
		...
		//todo: boundGuard and xray interactions should be agnostic of their order in the collection!
		{
	...
	void testWithPerft() {
		...
		test("r1bqr1k1/p1p2ppp/2p2n2/3p4/4P3/2BB4/PPP2PPP/R2QR1K1 b - - 0 11", 3, "captures:551C6EDCFBE04544956BFAB1|boundDefenders:F825F53A|xRays:05BF7CD9|quiet:9838D6D71AFA8F1B");
		test("r1bqr1k1/p1p2ppp/2p2n2/3p4/4P3/2BB4/PPP2PPP/R2QR1K1 b - - 0 11", 4, "captures:D22E135714D5F72928B6D4E6|boundDefenders:87E1F2D4|xRays:0225C9E0|quiet:151182243C1253C0");
		...
		test("1k4B1/3r1Qrp/3pp3/6P1/4P2n/5b2/6Q1/6K1 w - - 0 1", 3, "captures:71A37F69A95F748766F4AD72|boundDefenders:B88E7838|xRays:1177C109|quiet:B311D4355AD69EC5");
		test("1k4B1/3r1Qrp/3pp3/6P1/4P2n/5b2/6Q1/6K1 w - - 0 1", 4, "captures:2B24CF1DE721CA7C8691151C|boundDefenders:96D0E1D0|xRays:167185E3|quiet:5BA36B5044B2DEFB");
		...
		test("6k1/6b1/8/rQ1R1q1R/8/8/1n6/2K1N3 w - - 0 1", 4, "captures:2B92EA2AB0063FD69D17411E|boundDefenders:DB80E300|xRays:7AE94530|quiet:43A42F5C68EDD29F");
		...
		test("2b5/rp1n1kpp/p2B1b2/8/3N4/3Q4/6PP/2R4K w - - 4 31", 4, "captures:79775ED2F00CCDD73979DCA0|boundDefenders:A5C6A233|xRays:AF9FBDC7|quiet:271D2F5DBEC65E0A");
		...
		test("r2krb2/ppq5/2p5/5Q2/3PR3/2P1N2P/PP3PP1/R5K1 w - - 3 29", 4, "captures:BEAB781488AC2C9E49303D93|boundDefenders:CF2059E3|xRays:2366874F|quiet:C0E44360A8236B72");
		...
		test("3r1rk1/1bpq1pp1/5bnp/1p1n4/pN4N1/P1B3P1/1P1QRPBP/4R1K1 w - - 0 1", 4, "captures:17379A41E264F066234FDDCC|boundDefenders:2318799D|xRays:8CA9956D|quiet:D88CC70C75ACBA15");
		...
		test("2k5/1bnpp3/2q2n1p/6rr/PP6/NB2RN2/1B1R1KPP/4Q3 w - - 0 1", 3, "captures:DF99C82162CAA25C8FC62D12|boundDefenders:926E7448|xRays:87B7BF96|quiet:0B3CD33FF14AD5DD");
		test("2k5/1bnpp3/2q2n1p/6rr/PP6/NB2RN2/1B1R1KPP/4Q3 w - - 0 1", 4, "captures:A4C2D47F91DF14CDBD0BA29D|boundDefenders:B7D05D5B|xRays:5EE02C98|quiet:02DE44D76F874A6B");
		...
		test("5rk1/pb3ppp/1p5r/3p2q1/3Nn3/P3PBP1/1PQ2P1P/3RR1K1 b - - 0 21", 3, "captures:E87CAAEFE1D8B701FB8FA375|boundDefenders:DC346B0F|xRays:73618B79|quiet:72C139AE116216AA");
		test("5rk1/pb3ppp/1p5r/3p2q1/3Nn3/P3PBP1/1PQ2P1P/3RR1K1 b - - 0 21", 4, "captures:03259707B5E007AEA01804CF|boundDefenders:2FE04088|xRays:15575447|quiet:04A8C89A7D798F10");
		...
		test("r4rk1/3q2pp/2n2p2/3p4/2pP3P/2P1N3/2Q2P1P/R3R1K1 b - - 0 24", 4, "captures:11010AA4F0C229E6E3488B73|boundDefenders:C09AD008|xRays:403FFE2C|quiet:6BA68C00775E0D53");
		...
		test("r2r2k1/ppq2pb1/4b1pp/nP1np3/B3N3/B1PP1NP1/2Q2P1P/1R2R1K1 b - - 0 18", 4, "captures:9E16FE631ADCC632D0F21F76|boundDefenders:B48ABD8D|xRays:5EA2C44A|quiet:4C900E88FECE855B");
		...
		test("r3r1k1/1ppq1p1p/p1n2bp1/3p1b2/3P4/BBP2N1P/P2Q1PPK/4RR2 b - - 3 18", 4, "captures:B725AC69845D835463DA6DFE|boundDefenders:2C0E15E2|xRays:012C0A35|quiet:FB920040EB61C3E5");
		...
		test("1r6/3q4/6r1/1p3b2/k7/1r1Q3P/4P2K/6R1 w - - 0 1", 4, "captures:C16ECDA533F7DAE84FC7DDBB|boundDefenders:9F164EAC|xRays:498514C5|quiet:B1A6886E9746E684");
		...
		test("3r2k1/5rpp/2pq4/2p2bNn/p1n1n3/P1P3P1/1P3PBP/R2QKR2 b - - 0 1", 4, "captures:44D953C3AF6C8AEDD6EE6147|boundDefenders:0FE1E1C5|xRays:0A582D02|quiet:146D9DE0369A50B9");
		...
		test("r3r1k1/3q1pbp/2p3p1/4p3/p1P1P3/2Rp1P2/PP4PP/2NQ1RK1 b - - 1 22", 4, "captures:38F269926B8801D7999CD03E|boundDefenders:1FF9E68E|xRays:56C11CFF|quiet:DD365F7BA676BBF2");
		...
		test("r2r2k1/1b2qppp/3p1b2/p1nP4/2R1PB2/Q4N1P/5PP1/1N2R1K1 w - - 0 26", 4, "captures:41C214EAF6EC1DACDFAFF18D|boundDefenders:9DBD2CB4|xRays:18A9DC00|quiet:FD3A14A586ED77F8");
		...
		test("3q1r1k/p5bp/br4p1/3B4/3NQ3/R2n2P1/PP1N1PP1/2R3K1 w - - 1 26", 4, "captures:8A0627AB9C78EE7F286A6E96|boundDefenders:C13023F9|xRays:D3BBCCC8|quiet:AB6DC01CD481DE9B");
		...
		test("8/2kr1bb1/3r1q2/1n1p4/1n6/1NPQ4/1K1R1BB1/3R4 w - - 0 1", 4, "captures:4FF4AFA5D866ECC23BE2AE97|boundDefenders:D25983EF|xRays:DC073C68|quiet:117A315E08BAD040");
		...
		test("r3r1k1/pp1q1pp1/2p2p2/5b1p/3P1P2/2PBR1Q1/PP3P1P/R5K1 b - - 1 19", 4, "captures:817074D52E54DB356D1E9F66|boundDefenders:E8A0B355|xRays:1AC25E27|quiet:8B4958D9E03D7B87");
		...
		test("r2qr1k1/pp3pb1/2p1Rpp1/8/2PP1BQ1/6P1/1PB2P2/5RK1 w - - 1 27", 4, "captures:BE5CF795AC72BAA080DB5366|boundDefenders:A88455DF|xRays:F31CDEE2|quiet:5C94285B176FA9E1");
		...
		test("5rk1/pp1r1ppp/1qp1pn2/8/2PP4/1PQ2BP1/P4P1P/3RR1K1 w - - 5 19", 4, "captures:DDCCDFED0D5734EBA7072006|boundDefenders:C0BCD665|xRays:A27DC637|quiet:9B28A15B697C4A06");
		...
		test("2qr2k1/5rp1/1p1b1n1p/p2BB1p1/2P3P1/1P5P/P1Q2P2/3RR1K1 b - - 0 31", 4, "captures:85E28A1076AE423CABD78237|boundDefenders:323D7D94|xRays:F71D74F3|quiet:FF16252A0DEA6A71");
		...
		test("4r1k1/p5pp/8/8/2qb1N2/4nQP1/P5BP/4R2K b - - 1 32", 4, "captures:29F4CBF379A768612A409AF7|boundDefenders:0FD6F9D4|xRays:DC189F1F|quiet:50FCDF4F8EE2D71D");
		...
		test("6k1/1ppq1rp1/p1n4p/4pN1n/2b1P1P1/2P1Q2P/PP3RBK/8 w - - 0 26", 4, "captures:378368B649C33899CD874B92|boundDefenders:A547070A|xRays:DA95BFB0|quiet:DD17F4AE476929C6");
		...
		test("1k1r2q1/pbp3qp/1b1r2q1/1P2n3/1N3nQ1/1P5B/PBP1NPRP/2K1Q1RB w - - 0 1", 4, "captures:4081D095389E2E63B7A76E52|boundDefenders:B002F167|xRays:141BC3BD|quiet:FCB9A938222F694B");
		...
		test("8/2kp1rp1/1np4p/7P/3q4/1PNR1q2/1P1r2B1/1K1R3Q b - - 0 1", 3, "captures:3F6839C935790793D40C169C|boundDefenders:BF2714EC|xRays:37105BFC|quiet:C0861FB1B9C8151D");
		test("8/2kp1rp1/1np4p/7P/3q4/1PNR1q2/1P1r2B1/1K1R3Q b - - 0 1", 4, "captures:3D936835BA74283D294D6519|boundDefenders:35327262|xRays:8B5349C1|quiet:7884ED40A1481CD9");
