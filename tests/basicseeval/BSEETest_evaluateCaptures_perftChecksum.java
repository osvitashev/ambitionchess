...
class BSEETest_evaluateCaptures_perftChecksum {
	...
	void testWithPerft_captures() {
		...
		test("8/ppn2p2/2p1bk1p/2P4P/PP1PBKP1/5P2/8/8 w - - 1 38", 4, "F76FE1CF2DF73936E1C625C6");
		...
		test("8/8/7p/2Pn2P1/2kP4/1p3r2/pK6/R3B3 w - - 0 52", 4, "72EDA84EB1CD7CDDD36BBD73");
		test("1R6/2r2p2/8/2r1k1p1/2p4p/1p2P2P/1P2K1P1/2R5 w - g6 0 36", 4, "68513A9DC61B4FA284BDF17D");
		...
		test("8/5n1P/5k2/1p1K4/8/P7/8/8 w - - 1 50", 4, "C36D6C5F414194D2B6728F4A");
		...
		test("8/8/8/6p1/5k2/5P1p/5K2/8 w - - 0 65", 4, "A52BE3007B941D5EE0CE132F");
		...
		test("r7/P7/1r1pkpp1/2n4p/5B1P/4RPK1/3R2P1/8 b - - 11 40", 4, "273975593880D1697B3FC8BB");
		test("5bk1/p4p1p/1P4p1/3p4/3P4/4P1P1/2rB1P1P/1R4K1 b - - 0 24", 4, "9D5AED02F03F714375205365");
		test("8/8/5kp1/6Np/2B4P/3P2P1/5PK1/2r5 w - - 1 36", 4, "4FCA65E93B1380B97356E357");
		...
		test("8/2r3p1/3kpp1p/1p6/pPnP1P2/P2K1NP1/2R3P1/8 b - - 2 37", 4, "90A06E720F21D39AE08EDA9E");
		...
		test("8/3R4/p1r1pkp1/1p4N1/3P2r1/P1P2K2/1P3P2/7R b - - 1 41", 4, "EEBE1F9B40060E3B8AB0B9AF");
		...
		test("2br4/1p4pp/q2r1k1n/p6P/p2K1PP1/n5N1/1Q4BP/5R2 w - - 0 1", 4, "A565B8AC47F5AE56E99DF94E");
		...
		test("2r5/1qr2p2/3p2n1/1P2pp2/3k3P/1PP1RP2/1BPK1NN1/2N1R3 b - - 0 1", 4, "CA6A14E821BA8D6562A4ACCF");
		...
		test("3r1q2/rb1pp1n1/1p2k2p/p5p1/2KP1p2/PB6/1Q4PP/5R2 w - - 0 1", 4, "BA27A07C007209EAD646EF0D");
		test("8/8/8/1k4r1/8/8/3K4/8 w - - 0 1", 4, "6F3585BC589D7ABEB04864C9");
		test("8/4q3/8/1k6/8/8/3K4/8 w - - 0 1", 4, "11847CAE26B702B9033CF45B");
		test("8/2q1qr2/2b2pp1/1k5r/1pp2nn1/3P4/3K4/8 w - - 0 1", 4, "60AEAC3D6033B0E957A8F4BA");
		...
		test("8/p1b5/5kp1/1ppR4/2P2PR1/3K4/P2r1r2/8 w - - 6 40", 4, "FC35EA69160C40925358563A");
		...
		test("7R/8/8/2Kp4/k1b4P/6r1/8/8 w - - 9 61", 4, "3D1D32680E41CE781EA76583");
		...
		test("8/7p/2p2kp1/p3p3/4P2P/2P1K1P1/r3B3/8 w - a6 0 31", 4, "DFB52090892CC61D4A745811");
		...
		test("8/p4pp1/1p2k2p/3pN3/3P1P2/P5Pb/4K2P/8 b - - 2 29", 4, "14F8AFE1DD8E69F14F520135");
		...
		test("r1b4r/pp1p3p/6p1/3NQp2/2q5/1k6/5PPP/R1BK4 w - - 0 24", 4, "BCDFDBBE3D81DF9C09837342");
		...
		test("8/pR3pkp/1bR3p1/6K1/8/5BP1/P1n4P/6r1 b - - 8 38", 4, "678154A790BF2BB23C366BC6");
		...
		test("2r5/2r5/4kn2/5r1p/6P1/3K4/2Q5/8 w - - 0 1", 4, "E8F1A7E9551082EFEEFF1A75");
		...
		test("8/q2rN2p/6p1/4pR1b/R2RkN2/P1Q5/1P2n1K1/6b1 b - - 0 1", 3, "446A64E1400B1324452B1D8C");
		test("8/q2rN2p/6p1/4pR1b/R2RkN2/P1Q5/1P2n1K1/6b1 b - - 0 1", 4, "0EE9FF621F6E31D0607FC03F");
		...
		test("5r2/6p1/pppk1p2/6p1/PPKP4/4RP1P/6P1/8 b - b3 0 35", 3, "5F7701325ABA525998C51300");
		test("5r2/6p1/pppk1p2/6p1/PPKP4/4RP1P/6P1/8 b - b3 0 35", 4, "5314D13A0DE56DCE7AD694F3");
		...
		test("2r5/8/B2n1n2/4pkn1/8/2NK4/4P3/4R3 w - - 0 1", 2, "B4BADF1F4718593DF15FAC7D");
		test("2r5/8/B2n1n2/4pkn1/8/2NK4/4P3/4R3 w - - 0 1", 3, "A6E61DCACF8C3A18C8CF62A3");
		test("2r5/8/B2n1n2/4pkn1/8/2NK4/4P3/4R3 w - - 0 1", 4, "F55C8079C6F894CB2073CBF9");
		...
		test("8/8/2Rb3p/1P1kN3/3P1P2/7P/2p3PK/2r5 w - - 1 38", 4, "7BD7E6EEB964D9BAA6A85961");
