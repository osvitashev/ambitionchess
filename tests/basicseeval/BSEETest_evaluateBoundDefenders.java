...
class BSEETest_evaluateBoundDefenders {
	...
	void test_individualTarget() {
		...
		test_eval.evaluateTargetBoundDefenders(Square.E6, Player.WHITE);
		...
		test_eval.evaluateTargetBoundDefenders(Square.E4, Player.WHITE);
		assertDefenderInteractions(new int[] {});
		//many candidates
		init("3r2b1/ppnr4/1N2knpp/2Kp1p2/1N6/1B1Q1qp1/PP4bP/3R4 b - - 1 2");
		test_eval.evaluateTargetBoundDefenders(Square.D5, Player.WHITE);
		assertDefenderInteractions(new int[] {
		...
		test_eval.evaluateTargetBoundDefenders(Square.D4, Player.WHITE);
		assertDefenderInteractions(new int[] {
		...
		test_eval.evaluateTargetBoundDefenders(Square.G4, Player.BLACK);
		assertDefenderInteractions(new int[] {});
		...
		test_eval.evaluateTargetBoundDefenders(Square.D6, Player.WHITE);
		assertDefenderInteractions(new int[] {});
		init("8/1k6/b7/1b6/2q5/3q1R2/5N1K/8 w - - 0 1");
		test_eval.evaluateTargetBoundDefenders(Square.D3, Player.WHITE);
		assertDefenderInteractions(new int[] {});
		...
		test_eval.evaluateTargetBoundDefenders(Square.C5, Player.WHITE);
		assertDefenderInteractions(new int[] {});
		//negative->neutral
		...
		test_eval.evaluateTargetBoundDefenders(Square.D4, Player.BLACK);
		assertDefenderInteractions(new int[] {
		...
		test_eval.evaluateTargetBoundDefenders(Square.D5, Player.BLACK);
		assertDefenderInteractions(new int[] {});
		//neutral->positive
